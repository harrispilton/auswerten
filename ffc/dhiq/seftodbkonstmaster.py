...
plt.figure(1)
with open('dbkonstmaster/Jmaster_parameter.dat','r') as fin:
	lines=fin.readlines()
	diffs=[]
	r0s=[]
	konsts=[]
	...
	konst=calc_konst(10**diffs[0],r0s[0])
	print konst
	r0s=[]
	for d in diffs:
...
skonst=Slider(axkonst,'log konst',konst/10.,konst*3.,valinit=konst)
...
with open('dbkonstmaster/Jmaster_parameter.dat','w') as fout:
